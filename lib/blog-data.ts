...
That specificity shows up in the details. A petrol car costs you roughly **0.21 kg CO2 per kilometer**, a diesel car 0.17, an electric car 0.12. A bus ride comes in at 0.089 kg/km, while the Delhi or Mumbai metro drops that figure to just **0.041**. That single number makes the case for public transit better than any lecture could.

On the food side, a beef-based meal carries roughly ten times the footprint of a vegan one (**3.0 kg CO2 versus 0.2 kg**), with chicken and vegetarian options sitting somewhere in between.
...
Rather than serving up generic advice, Canopy plugs into **Google's Gemini 2.0 Flash** model to build a coach that responds to your actual logged behavior. It looks at your real activity data, quantifies the CO2 impact of specific changes, and frames suggestions within an Indian context, with a smart offline fallback so the experience doesn't break when connectivity does.
